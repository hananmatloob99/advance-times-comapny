...
//   return (
//     <section className="bg-red-900 py-12 px-4 sm:px-6 lg:px-12 overflow-x-hidden">
//       <div className="max-w-7xl mx-auto grid gap-10 md:grid-cols-3 text-center text-white w-full">
//         {items.map((item, index) => (
//           <div
//             key={index}
